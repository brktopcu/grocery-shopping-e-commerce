<%@ Page MaintainScrollPositionOnPostback="true" Title="Siparişlerim" Language="C#" MasterPageFile="~/master1.Master" AutoEventWireup="true" CodeBehind="siparislerim.aspx.cs" Inherits="zeytin.siparislerim" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <body>
        ...
        <form id="admin" runat="server">
            <div>
                <h3 style="text-align: center; text-decoration: underline;">Siparişler:</h3>
                <br />
            </div>
            <div class="container">
                <div class="row">
                    <div style="width: 93%; margin-left: 3%; text-align: center">
                        ...
                        <asp:GridView ID="grdSiparisler"  runat="server" BackColor="#CCCCCC" BorderColor="#999999" BorderStyle="Solid" BorderWidth="3px" CellPadding="4" AutoGenerateColumns="False" OnRowCommand="grdSiparisler_RowCommand" CellSpacing="2" ForeColor="Black" Style="width:100%">
                            <Columns>
