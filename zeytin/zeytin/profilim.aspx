...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <form runat="server" action="#" method="post">
        <div Style="text-align:center">
            <asp:LinkButton ID="btnaktif" runat="server" CssClass="linkbtn2" Visible="false" OnClick="btnaktif_Click" Style="font-size:16pt;">Hesabınız aktif değil.Aktifleştirmek için tıklayınız.</asp:LinkButton>
        </div>
        <br />
